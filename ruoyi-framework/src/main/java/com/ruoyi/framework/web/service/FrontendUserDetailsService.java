...
{
    private static final Logger log = LoggerFactory.getLogger(FrontendUserDetailsService.class);

    @Autowired
    private IPlanetUsersService userService;
    ...
    {
        PlanetUsers user = userService.selectUserByUserName(username);
