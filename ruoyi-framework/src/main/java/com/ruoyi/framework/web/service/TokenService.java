...
public class TokenService
{
    ...
    public AbstractLoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            try
            {
                ...
                AbstractLoginUser user = redisCache.getCacheObject(userKey);
                return user;
            }
            catch (Exception e)
            {
    ...
    public String createToken(PlanetLoginUser loginUser)
    {
        String token = IdUtils.fastUUID();
        loginUser.setToken(token);
        setUserAgent(loginUser);
    ...
    public void setUserAgent(PlanetLoginUser loginUser)
    {
        UserAgent userAgent = UserAgent.parseUserAgentString(ServletUtils.getRequest().getHeader("User-Agent"));
        String ip = IpUtils.getIpAddr();
        loginUser.setIpaddr(ip);
